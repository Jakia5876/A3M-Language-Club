        ...
        <section class="section">
            <div class="container">
                <div class="section-header animate-slide-up">
                    ...
                    <p>Browse our extensive catalog of Japanese and Chinese courses designed for all levels.</p>
                </div>
                ...
                <div class="text-center" style="margin-top: var(--space-8);">
                    <a href="#/courses" class="btn btn-outline btn-xl">View All Courses</a>
                </div>
            </div>
        </section>
